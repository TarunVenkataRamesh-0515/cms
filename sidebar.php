<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="messageadmin"><a href="./messageadmin.php"><i class="fa fa-envelope"></i> <span>Inbox</span> </a></li>
        </span> </a></li>
      ...
      <li id="notice-role"><a href="./notice-role.php"><i class="fa fa-envelope-o"></i> <span>Notice</span> </a></li>
      <li id="exam"><a href="./exam-stu.php"><i class="fa fa-line-chart"></i> <span>Exam</span> </a></li>
